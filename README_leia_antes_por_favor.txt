...
3.1) Vamos criar seu ambiente virtual e ativá-lo. Execute os 3 comandos em sequência:
...
3.2) Instalando as dependências necessárias do projeto. Execute os 2 comandos a seguir:
